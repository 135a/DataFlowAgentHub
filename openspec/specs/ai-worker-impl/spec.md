# AI Worker Implementation Spec

## Purpose

定义 Python AI Worker（`services/ai/hub_ai/`）的 gRPC 服务端实现规范，涵盖 GenerateSQL、RunAgentPipeline、Health 三个核心 RPC 方法及其与 Go API 的 gRPC 直连通信。
